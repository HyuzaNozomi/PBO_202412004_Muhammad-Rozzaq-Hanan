def operasi():
    ...
    try:
        ...
        if x == "" or y == "":
            raise ValueError("Input tidak boleh kosong. Anda menekan Enter tanpa memasukkan angka.")
        ...
        if a < 0 or b < 0:
            raise ValueError("Hanya menerima bilangan positif. Masukkan angka yang lebih besar atau sama dengan 0.")
